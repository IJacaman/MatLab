...
b=desk_original;
desk_m = imread("c:\Users\issa_\OneDrive\PPU University\Semester 8\MatLab\Desk\All\Without CBC\m_encrypted.bmp");
desk_mc = imread("c:\Users\issa_\OneDrive\PPU University\Semester 8\MatLab\Desk\All\Without CBC\mc_encrypted.bmp");
desk_mcp = imread("c:\Users\issa_\OneDrive\PPU University\Semester 8\MatLab\Desk\All\Without CBC\mcp_encrypted.bmp");
desk_mcpb = imread("c:\Users\issa_\OneDrive\PPU University\Semester 8\MatLab\Desk\All\Without CBC\mcpb_encrypted.bmp");
...
saveas(gcf,sprintf('desk_all_m_r_histogram.png',i));
%%%%%%%%%%          G           %%%%%%%%%%%%
desk_m_g = desk_m(:,:,2);
...
saveas(gcf,sprintf('desk_all_m_g_histogram.png',i));
%%%%%%%%%%          B           %%%%%%%%%%%%
desk_m_b = desk_m(:,:,3);
...
saveas(gcf,sprintf('desk_all_m_b_histogram.png',i));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%            desk_m_r         %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
subplot(1,1,1)
plot(IA(1:end-1, 1:end-1), IA(2:end, 2:end),'r'),title(sprintf('%s Horizontal Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/M/r_h.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(1:end-1, :), IA(2:end, :),'r'),title(sprintf('%s Vertical Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/M/r_v.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(:, 1:end-1, :), IA(:, 2:end),'r'),title(sprintf('%s Diagonal Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/M/r_d.png',i));
%pause(10);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%        desk_m_g             %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
subplot(1,1,1)
plot(IA(1:end-1, 1:end-1), IA(2:end, 2:end),'g'),title(sprintf('%s Horizontal Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/M/g_h.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(1:end-1, :), IA(2:end, :),'g'),title(sprintf('%s Vertical Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/M/g_v.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(:, 1:end-1, :), IA(:, 2:end),'g'),title(sprintf('%s Diagonal Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/M/g_d.png',i));
%pause(10);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%        desk_m_b             %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
subplot(1,1,1)
plot(IA(1:end-1, 1:end-1), IA(2:end, 2:end),'b'),title(sprintf('%s Horizontal Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/M/b_h.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(1:end-1, :), IA(2:end, :),'b'),title(sprintf('%s Vertical Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/M/b_v.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(:, 1:end-1, :), IA(:, 2:end),'b'),title(sprintf('%s Diagonal Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/M/b_d.png',i));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
saveas(gcf,sprintf('desk_all_m_histogram.png',i));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
saveas(gcf,sprintf('desk_all_mc_r_histogram.png',i));
%%%%%%%%%%      G      %%%%%%%%%%
desk_mc_g = desk_mc(:,:,2);
...
saveas(gcf,sprintf('desk_all_mc_g_histogram.png',i));
%%%%%%%%%%      B      %%%%%%%%%%
desk_mc_b = desk_mc(:,:,3);
...
saveas(gcf,sprintf('desk_all_mc_b_histogram.png',i));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
saveas(gcf,sprintf('desk_all_mc_histogram.png',i));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%            desk_mc_r         %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
subplot(1,1,1)
plot(IA(1:end-1, 1:end-1), IA(2:end, 2:end),'r'),title(sprintf('%s Horizontal Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/MC/r_h.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(1:end-1, :), IA(2:end, :),'r'),title(sprintf('%s Vertical Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/MC/r_v.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(:, 1:end-1, :), IA(:, 2:end),'r'),title(sprintf('%s Diagonal Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/MC/r_d.png',i));
%pause(10);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%        desk_mc_g             %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
subplot(1,1,1)
plot(IA(1:end-1, 1:end-1), IA(2:end, 2:end),'g'),title(sprintf('%s Horizontal Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/MC/g_h.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(1:end-1, :), IA(2:end, :),'g'),title(sprintf('%s Vertical Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/MC/g_v.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(:, 1:end-1, :), IA(:, 2:end),'g'),title(sprintf('%s Diagonal Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/MC/g_d.png',i));
%pause(10);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%        desk_mc_b             %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
subplot(1,1,1)
plot(IA(1:end-1, 1:end-1), IA(2:end, 2:end),'b'),title(sprintf('%s Horizontal Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/MC/b_h.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(1:end-1, :), IA(2:end, :),'b'),title(sprintf('%s Vertical Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/MC/b_v.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(:, 1:end-1, :), IA(:, 2:end),'b'),title(sprintf('%s Diagonal Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/MC/b_d.png',i));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
saveas(gcf,sprintf('desk_all_mcp_r_histogram.png',i));
%%%%%%%%%%      G      %%%%%%%%%%
...
saveas(gcf,sprintf('desk_all_mcp_g_histogram.png',i));
%%%%%%%%%%      B      %%%%%%%%%%
...
saveas(gcf,sprintf('desk_all_mcp_b_histogram.png',i));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
saveas(gcf,sprintf('desk_all_mcp_histogram.png',i));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%            desk_mcp_r         %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
subplot(1,1,1)
plot(IA(1:end-1, 1:end-1), IA(2:end, 2:end),'r'),title(sprintf('%s Horizontal Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/MCP/r_h.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(1:end-1, :), IA(2:end, :),'r'),title(sprintf('%s Vertical Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/MCP/r_v.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(:, 1:end-1, :), IA(:, 2:end),'r'),title(sprintf('%s Diagonal Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/MCP/r_d.png',i));
%pause(10);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%        desk_mcp_g             %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
subplot(1,1,1)
plot(IA(1:end-1, 1:end-1), IA(2:end, 2:end),'g'),title(sprintf('%s Horizontal Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/MCP/g_h.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(1:end-1, :), IA(2:end, :),'g'),title(sprintf('%s Vertical Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/MCP/g_v.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(:, 1:end-1, :), IA(:, 2:end),'g'),title(sprintf('%s Diagonal Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/MCP/g_d.png',i));
%pause(10);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%        desk_mcp_b             %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
subplot(1,1,1)
plot(IA(1:end-1, 1:end-1), IA(2:end, 2:end),'b'),title(sprintf('%s Horizontal Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/MCP/b_h.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(1:end-1, :), IA(2:end, :),'b'),title(sprintf('%s Vertical Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/MCP/b_v.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(:, 1:end-1, :), IA(:, 2:end),'b'),title(sprintf('%s Diagonal Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/MCP/b_d.png',i));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
saveas(gcf,sprintf('desk_all_mcpb_r_histogram.png',i));
%%%%%%%%%%      G      %%%%%%%%%%
...
saveas(gcf,sprintf('desk_all_mcpb_g_histogram.png',i));
%%%%%%%%%%      B      %%%%%%%%%%
...
saveas(gcf,sprintf('desk_all_mcpb_b_histogram.png',i));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
saveas(gcf,sprintf('desk_all_mcpb_histogram.png',i));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%            desk_mcpb_r         %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
subplot(1,1,1)
plot(IA(1:end-1, 1:end-1), IA(2:end, 2:end),'r'),title(sprintf('%s Horizontal Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/MCPB/r_h.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(1:end-1, :), IA(2:end, :),'r'),title(sprintf('%s Vertical Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/MCPB/r_v.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(:, 1:end-1, :), IA(:, 2:end),'r'),title(sprintf('%s Diagonal Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/MCPB/r_d.png',i));
%pause(10);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%        desk_mcpb_g             %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
subplot(1,1,1)
plot(IA(1:end-1, 1:end-1), IA(2:end, 2:end),'g'),title(sprintf('%s Horizontal Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/MCPB/g_h.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(1:end-1, :), IA(2:end, :),'g'),title(sprintf('%s Vertical Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/MCPB/g_v.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(:, 1:end-1, :), IA(:, 2:end),'g'),title(sprintf('%s Diagonal Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/MCPB/g_d.png',i));
%pause(10);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%        desk_mcpb_b             %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
subplot(1,1,1)
plot(IA(1:end-1, 1:end-1), IA(2:end, 2:end),'b'),title(sprintf('%s Horizontal Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/MCPB/b_h.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(1:end-1, :), IA(2:end, :),'b'),title(sprintf('%s Vertical Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/MCPB/b_v.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(:, 1:end-1, :), IA(:, 2:end),'b'),title(sprintf('%s Diagonal Orginal image',b));
saveas(gcf,sprintf('CC/desk/Without CBC/All/MCPB/b_d.png',i));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
writecell(arr,'desk_all.xls','Sheet',1,'Range','B3:E7');
...
writecell(arr,'desk_all.xls','Sheet',1,'Range','B10:E14');
...
writecell(arr,'desk_all.xls','Sheet',1,'Range','B16:E20');
...
writecell(arr,'desk_all.xls','Sheet',1,'Range','B22:E26');
...
writecell(arr,'desk_all.xls','Sheet',1,'Range','B28:E32');
...
writecell(arr,'desk_all.xls','Sheet',1,'Range','B34:E36');
...
writecell(arr,'desk_all.xls','Sheet',1,'Range','B34:E38');
...
writecell(arr,'desk_all.xls','Sheet',1,'Range','B40:E44');
...
writecell(arr,'desk_all.xls','Sheet',1,'Range','B46:E50');


arr = {'Process','original_r_ie', 'original_g_ie','original_b_ie'; 
    'desk',original_r_ir, original_g_ir, original_b_ir
    };
writecell(arr,'desk_all.xls','Sheet',1,'Range','B52:E56');
...
writecell(arr,'desk_all.xls','Sheet',1,'Range','B58:E62');
...
writecell(arr,'desk_all.xls','Sheet',1,'Range','B64:E68');