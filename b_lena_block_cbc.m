...
b=lena_original;
lena_m = imread("c:\Users\issa_\OneDrive\PPU University\Semester 8\MatLab\Lena\Blocks\With CBC\m_encrypted.png");
lena_mc = imread("c:\Users\issa_\OneDrive\PPU University\Semester 8\MatLab\Lena\Blocks\With CBC\mc_encrypted.png");
lena_mcp = imread("c:\Users\issa_\OneDrive\PPU University\Semester 8\MatLab\Lena\Blocks\With CBC\mcp_encrypted.png");
lena_mcpb = imread("c:\Users\issa_\OneDrive\PPU University\Semester 8\MatLab\Lena\Blocks\With CBC\mcpb_encrypted.png");
...
%%%saveas(gcf,sprintf('lena_blocks_cbc_m_r_histogram.png',i));
%%%%%%%%%%          G           %%%%%%%%%%%%
lena_m_g = lena_m(:,:,2);
...
%%%saveas(gcf,sprintf('lena_blocks_cbc_m_g_histogram.png',i));
%%%%%%%%%%          B           %%%%%%%%%%%%
lena_m_b = lena_m(:,:,3);
...
%%%saveas(gcf,sprintf('lena_blocks_cbc_m_b_histogram.png',i));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%            lena_m_r         %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
subplot(1,1,1)
plot(IA(1:end-1, 1:end-1), IA(2:end, 2:end),'r'),title(sprintf('%s Horizontal Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/M/r_h.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(1:end-1, :), IA(2:end, :),'r'),title(sprintf('%s Vertical Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/M/r_v.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(:, 1:end-1, :), IA(:, 2:end),'r'),title(sprintf('%s Diagonal Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/M/r_d.png',i));
%pause(10);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%        lena_m_g             %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
subplot(1,1,1)
plot(IA(1:end-1, 1:end-1), IA(2:end, 2:end),'g'),title(sprintf('%s Horizontal Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/M/g_h.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(1:end-1, :), IA(2:end, :),'g'),title(sprintf('%s Vertical Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/M/g_v.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(:, 1:end-1, :), IA(:, 2:end),'g'),title(sprintf('%s Diagonal Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/M/g_d.png',i));
%pause(10);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%        lena_m_b             %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
subplot(1,1,1)
plot(IA(1:end-1, 1:end-1), IA(2:end, 2:end),'b'),title(sprintf('%s Horizontal Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/M/b_h.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(1:end-1, :), IA(2:end, :),'b'),title(sprintf('%s Vertical Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/M/b_v.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(:, 1:end-1, :), IA(:, 2:end),'b'),title(sprintf('%s Diagonal Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/M/b_d.png',i));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%saveas(gcf,sprintf('lena_blocks_cbc_m_histogram.png',i));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% %%saveas(gcf,sprintf('lena_blocks_cbc_mc_r_histogram.png',i));
%%%%%%%%%%      G      %%%%%%%%%%
lena_mc_g = lena_mc(:,:,2);
...
% %%saveas(gcf,sprintf('lena_blocks_cbc_mc_g_histogram.png',i));
%%%%%%%%%%      B      %%%%%%%%%%
lena_mc_b = lena_mc(:,:,3);
...
% %%saveas(gcf,sprintf('lena_blocks_cbc_mc_b_histogram.png',i));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% %%saveas(gcf,sprintf('lena_blocks_cbc_mc_histogram.png',i));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%            lena_mc_r         %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
subplot(1,1,1)
plot(IA(1:end-1, 1:end-1), IA(2:end, 2:end),'r'),title(sprintf('%s Horizontal Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/MC/r_h.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(1:end-1, :), IA(2:end, :),'r'),title(sprintf('%s Vertical Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/MC/r_v.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(:, 1:end-1, :), IA(:, 2:end),'r'),title(sprintf('%s Diagonal Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/MC/r_d.png',i));
%pause(10);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%        lena_mc_g             %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
subplot(1,1,1)
plot(IA(1:end-1, 1:end-1), IA(2:end, 2:end),'g'),title(sprintf('%s Horizontal Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/MC/g_h.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(1:end-1, :), IA(2:end, :),'g'),title(sprintf('%s Vertical Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/MC/g_v.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(:, 1:end-1, :), IA(:, 2:end),'g'),title(sprintf('%s Diagonal Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/MC/g_d.png',i));
%pause(10);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%        lena_mc_b             %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
subplot(1,1,1)
plot(IA(1:end-1, 1:end-1), IA(2:end, 2:end),'b'),title(sprintf('%s Horizontal Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/MC/b_h.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(1:end-1, :), IA(2:end, :),'b'),title(sprintf('%s Vertical Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/MC/b_v.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(:, 1:end-1, :), IA(:, 2:end),'b'),title(sprintf('%s Diagonal Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/MC/b_d.png',i));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% %%saveas(gcf,sprintf('lena_blocks_cbc_mcp_r_histogram.png',i));
%%%%%%%%%%      G      %%%%%%%%%%
...
% %%saveas(gcf,sprintf('lena_blocks_cbc_mcp_g_histogram.png',i));
%%%%%%%%%%      B      %%%%%%%%%%
...
% %%saveas(gcf,sprintf('lena_blocks_cbc_mcp_b_histogram.png',i));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% %%saveas(gcf,sprintf('lena_blocks_cbc_mcp_histogram.png',i));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%            lena_mcp_r         %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
subplot(1,1,1)
plot(IA(1:end-1, 1:end-1), IA(2:end, 2:end),'r'),title(sprintf('%s Horizontal Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/MCP/r_h.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(1:end-1, :), IA(2:end, :),'r'),title(sprintf('%s Vertical Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/MCP/r_v.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(:, 1:end-1, :), IA(:, 2:end),'r'),title(sprintf('%s Diagonal Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/MCP/r_d.png',i));
%pause(10);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%        lena_mcp_g             %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
subplot(1,1,1)
plot(IA(1:end-1, 1:end-1), IA(2:end, 2:end),'g'),title(sprintf('%s Horizontal Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/MCP/g_h.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(1:end-1, :), IA(2:end, :),'g'),title(sprintf('%s Vertical Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/MCP/g_v.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(:, 1:end-1, :), IA(:, 2:end),'g'),title(sprintf('%s Diagonal Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/MCP/g_d.png',i));
%pause(10);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%        lena_mcp_b             %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
subplot(1,1,1)
plot(IA(1:end-1, 1:end-1), IA(2:end, 2:end),'b'),title(sprintf('%s Horizontal Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/MCP/b_h.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(1:end-1, :), IA(2:end, :),'b'),title(sprintf('%s Vertical Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/MCP/b_v.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(:, 1:end-1, :), IA(:, 2:end),'b'),title(sprintf('%s Diagonal Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/MCP/b_d.png',i));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% %%saveas(gcf,sprintf('lena_blocks_cbc_mcpb_r_histogram.png',i));
%%%%%%%%%%      G      %%%%%%%%%%
...
% %%saveas(gcf,sprintf('lena_blocks_cbc_mcpb_g_histogram.png',i));
%%%%%%%%%%      B      %%%%%%%%%%
...
% %%saveas(gcf,sprintf('lena_blocks_cbc_mcpb_b_histogram.png',i));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% %%saveas(gcf,sprintf('lena_blocks_cbc_mcpb_histogram.png',i));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%            lena_mcpb_r         %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
subplot(1,1,1)
plot(IA(1:end-1, 1:end-1), IA(2:end, 2:end),'r'),title(sprintf('%s Horizontal Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/MCPB/r_h.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(1:end-1, :), IA(2:end, :),'r'),title(sprintf('%s Vertical Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/MCPB/r_v.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(:, 1:end-1, :), IA(:, 2:end),'r'),title(sprintf('%s Diagonal Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/MCPB/r_d.png',i));
%pause(10);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%        lena_mcpb_g             %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
subplot(1,1,1)
plot(IA(1:end-1, 1:end-1), IA(2:end, 2:end),'g'),title(sprintf('%s Horizontal Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/MCPB/g_h.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(1:end-1, :), IA(2:end, :),'g'),title(sprintf('%s Vertical Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/MCPB/g_v.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(:, 1:end-1, :), IA(:, 2:end),'g'),title(sprintf('%s Diagonal Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/MCPB/g_d.png',i));
%pause(10);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%        lena_mcpb_b             %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
subplot(1,1,1)
plot(IA(1:end-1, 1:end-1), IA(2:end, 2:end),'b'),title(sprintf('%s Horizontal Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/MCPB/b_h.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(1:end-1, :), IA(2:end, :),'b'),title(sprintf('%s Vertical Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/MCPB/b_v.png',i));

figure('visible','off');
subplot(1,1,1)
plot(IA(:, 1:end-1, :), IA(:, 2:end),'b'),title(sprintf('%s Diagonal Orginal image',b));
saveas(gcf,sprintf('CC/Lena/CBC/Blocks/MCPB/b_d.png',i));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
writecell(arr,'lena_cbc_blocks.xls','Sheet',1,'Range','B3:E7');
...
writecell(arr,'lena_cbc_blocks.xls','Sheet',1,'Range','B10:E14');
...
writecell(arr,'lena_cbc_blocks.xls','Sheet',1,'Range','B16:E20');
...
writecell(arr,'lena_cbc_blocks.xls','Sheet',1,'Range','B22:E26');
...
writecell(arr,'lena_cbc_blocks.xls','Sheet',1,'Range','B28:E32');
...
writecell(arr,'lena_cbc_blocks.xls','Sheet',1,'Range','B34:E36');
...
writecell(arr,'lena_cbc_blocks.xls','Sheet',1,'Range','B34:E38');
...
writecell(arr,'lena_cbc_blocks.xls','Sheet',1,'Range','B40:E44');
...
writecell(arr,'lena_cbc_blocks.xls','Sheet',1,'Range','B46:E50');


arr = {'Process','original_r_ie', 'original_g_ie','original_b_ie'; 
    'Lena',original_r_ir, original_g_ir, original_b_ir
    };
writecell(arr,'lena_cbc_blocks.xls','Sheet',1,'Range','B52:E56');
...
writecell(arr,'lena_cbc_blocks.xls','Sheet',1,'Range','B58:E62');
...
writecell(arr,'lena_cbc_blocks.xls','Sheet',1,'Range','B64:E68');